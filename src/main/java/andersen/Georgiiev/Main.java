...
/**
 * Основной класс, содержит методы для тестирования коллекции:
 * добавление, удаление, получение минимального, максимального
 * и среднего значение, а так же получение итератора и работы с ним
 */
